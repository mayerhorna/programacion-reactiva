...
public class ProductResource {
    ...
    public Flowable<Product> findAll(@RequestParam int limit) {
		Flowable<Product> products = 
    ...
    @PutMapping(produces = {"application/json"})
   	public Maybe<Product> update(@Valid @RequestBody Product product) {
    ...
    public Maybe<Product> read(@PathVariable Long productId) {
        return this.productService.read(productId);
    }
    
    @DeleteMapping(PRODUCT_ID)
    public Maybe<ProductIdAndNameDto> delete(@PathVariable Long productId) {
